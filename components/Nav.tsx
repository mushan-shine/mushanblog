...
export default function Nav() {
  ...
  return (
    <header className="fixed z-50" style={{ top: pathname === "/" ? "38vh" : 0, left: 0, right: 0, height: "56px", background: "rgba(242,242,240,0.92)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
